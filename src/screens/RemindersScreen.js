...
import { Bell, Coffee, Utensils, Moon, Droplets, Scale } from 'lucide-react-native';
    ...
    <ScreenShell>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {ITEMS.map(({ key, label, sub, Icon, color }) => (
          <View key={key} style={[styles.row, { backgroundColor: c.cardBg, borderColor: c.border }]}>
            ...
            <Switch
              value={!!reminders[key]}
              onValueChange={(v) => updateReminder(key, v)}
